...
<body>
  <section>
  <form method="post">
    <span>Search for a place:<input type="text" name="searchbar" value="<?php echo $_SESSION['searchloc'] ?? 'London, UK' ?>"></span>
    <span>Select your timezone: <select name="timezone"></span>
   <option></option>
    ...
    $_SESSION['TZ'] = $TZ;
      ...
      if ($weather == false){
        ...
        $now=  date(time());
          ...
          echo "<section class=\"centered\"><p>The sun will rise at " . date("H:i", $sunrise) . ". The sun will set at " . date("H:i", $sunset) . " (Dates are in ". $_SESSION['TZ'] . " time).</p>";
          ...
          if ($cloudCover < 10){
            ...
            echo "<p>Cloudy skies. High around " . $maxtemp . "°C. Low around " . $mintemp . "°C.</p></section>";
          }
